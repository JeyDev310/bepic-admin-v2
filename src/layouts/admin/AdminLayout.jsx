...
import menuLogoImage from '@/assets/images/menuLogo.png';
          ...
          menuHeaderRender={() => {
            return (
              <div className="sider-logo">
                <Link to="/dashboard">
                  <img src={menuLogoImage} className="desktop-logo-header" alt="BEPIC" />
                  <img src={headerLogoImage} className="mobile-header" alt="BEPIC" />
                </Link>
              </div>
            );
          }}
