...
import flagImage from '@/assets/images/germany.jpg';
...
const EditDetailsForm = ({ loading, details, countries }) => {
  ...
  console.log('editName ttt', editName, newTitle);
  return (
    <Form
      {...layout}
      name="basic"
      ...
      {loading ? (
        ...
        <div className="product-details-container">
          <Card className={`${styles.card}`}>
                ...
                <div className="edit-dist-container mt-12 mb-12">
                  <div className="mb-12 mt-12">
                    <div className="uploadImg">
                      <div
                        style={{ backgroundImage: `url('${imagePreview || flagImage}')` }}
                  ...
                  <div className="mt-12 mb-12">
                    <UserStatusBadge status={details.status ? 'Active' : 'Inactive'} />
                  </div>
                </div>
              </Col>
            </Row>
            ...
            {isThirdParty ? (
              <Row gutter={[15, 0]} className="mt-10">
                <Col xs={12}>
                  <div className={`${styles.inputContainer}`}>
                    <Form.Item
