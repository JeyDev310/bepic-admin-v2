...
const productWeightUnitOptions = varOptions('product.weightUnit');
      ...
      <div className="product-details-container">
        <Card className={`${styles.card}`}>
          ...
          <Row gutter={[15, 15]}>
            <Col xs={24} sm={24}>
              <Checkbox
                className={`${styles.digitalProduct}`}
                label="This is a digital product"
                name="digital"
                checked={props.formData.is_digital === 1}
                onChange={(e) => props.onFormData('is_digital', e.target.checked ? 1 : 2)}
              />
            </Col>
          </Row>
                ...
                <Col xs={24} sm={24} md={24} lg={7}>
                  <div className={`${styles.inputContainer}`}>
                    <FormItem
                      ...
                      errorMessages={props.errorMessages.filter((el) => el.type === 'weight_value')}
                    >
                      <Input
                        type="number"
                        value={formData.weight_value}
                        onChange={(e) => onFormData('weight_value', e.target.value)}
                      />
                    </FormItem>
                  </div>
                </Col>
                <Col xs={24} sm={24} md={24} lg={5} className={styles.productWeight}>
                  <div className={`${styles.inputContainerWeight}`}>
                    <FormItem
                      label={'*Weight Unit'}
                      errorMessages={props.errorMessages.filter((el) => el.type === 'weight_unit')}
                    >
                      <Select
                        options={productWeightUnitOptions}
                        placeholder="Kilograms or Grams"
                        value={formData.weight_unit}
                        onChange={(v) => onFormData('weight_unit', v)}
                      />
                    </FormItem>
                  </div>
                </Col>
