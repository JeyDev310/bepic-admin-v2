...
const BackofficeModalContent = ({ paginationParam, searchParam, loadTable, allProductsOption, toggle }) => {
  ...
  const onFinish = async (values) => {
    ...
    addProductsAvailabilityApi('shop', formData, onSaveSuccess, onSaveError);
  };
