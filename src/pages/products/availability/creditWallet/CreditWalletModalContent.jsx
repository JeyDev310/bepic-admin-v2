...
const CreditWalletModalContent = ({ paginationParam, searchParam, loadTable, allProductsOption, toggle }) => {
  ...
  const onFinish = async (values) => {
    ...
    addProductsAvailabilityApi('credit_wallet', formData, onSaveSuccess, onSaveError);
  };
