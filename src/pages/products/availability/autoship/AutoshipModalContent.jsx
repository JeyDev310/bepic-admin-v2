...
const AutoshipModalContent = ({ paginationParam, searchParam, loadTable, allProductsOption, toggle }) => {
  ...
  const onFinish = async (values) => {
    ...
    addProductsAvailabilityApi('autoship', formData, onSaveSuccess, onSaveError);
  };
