...
import { createBroadcastEmailApi, createSendBroadcastEmailApi } from '@/services/emailCampaigns/broadcastEmails';
...
const CreateBroadcastEmailPage = () => {
  ...
  function validateForm() {
    let flag = false;
    const errorMessagesinValidation = [...errorMessages];
          ...
          <div className="text-container mt-10">
            ...
            <div className="actions">
              ...
              >
                <Button
                  type="success"
                  style={{ background: '#45B854', color: 'white', marginRight: 10, height: 35 }}
                  loading={isLoading}
                >
              ...
              >
                <Button type="primary" isLoading={isLoadingSend}>
