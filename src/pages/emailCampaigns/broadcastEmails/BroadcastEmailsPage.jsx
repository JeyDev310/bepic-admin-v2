...
const BroadcastEmailsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      title: 'Created On',
      key: 'created_at',
      render: (_, record) => <p className="mb-0">{asDate(record.created_at)}</p>,
    },
    {
      title: 'Status',
      key: 'status',
      ...
      <div className="page-content settings-page payment-provider-table-container">
        <Row gutter={[15, 5]} className="mb-15" align="middle">
          ...
          <Col xs={24} sm={12} lg={12} className={styles.createBroadcastBtn}>
            <Link
              to={`/email-campaigns/broadcast-email/create`}
...
export default BroadcastEmailsPage;
