...
import {
  Card, Row, Col, Button, notification, FormItem
} from '@/components';

import { saveSystemEmailDetailContentApi, restoreSystemEmailDetailContentApi } from '@/services/emailCampaigns/systemEmails';
...
const EmailDetailForm = ({ logoImage, footerText, emailId, content }) => {
  ...
  const onSaveSystemEmailDetail = (res) => {
  ...
  const handleSave = () => {
    ...
    if (validResult) {
      ...
      saveSystemEmailDetailContentApi(emailId, contentInput, onSaveSystemEmailDetail, onFailSaveSystemEmailDetail);
    }
  }
  ...
  const handleRestore = () => {
    if (isLoadingRestore === false) {
      ...
      restoreSystemEmailDetailContentApi(emailId, onRestoreSystemEmailDetail, onFailRestoreSystemEmailDetail);
    }
  }
