...
import { Form, Row, Col, Input, OutlineBtn, SuccessNotification, Radio } from '@/components';
          ...
          <Col xs={24}>
            <div className={`${styles.inputContainer}`}>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Enter Max Number of Transactions Per Day' }]}
              >
                <Input />
              </Form.Item>
            </div>
          ...
          <Col xs={24}>
            <div className={`${styles.inputContainer}`}>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Enter Max Amount Per Day' }]}
              >
                <Input />
              </Form.Item>
            </div>
