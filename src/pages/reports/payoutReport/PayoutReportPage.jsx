...
const PayoutReportPage = () => {
  ...
  const [statsData, setStatsData] = useState([
    { title: 'Last Week Payout', amount: null, percent: null },
    { title: 'Last Month Payout', amount: null, percent: null },
    { title: 'Last Year Payout', amount: null },
    { title: 'Total Lifetime Payout', amount: null },
  ]);
  ...
  const onGetSuccessPayoutHeader = (data) => {
    setStatsData([
      ...
      {
        title: 'Last Year Payout',
        amount: asPrice(data.last_year_amount),
        percent: data.last_year_percent,
      },
      { title: 'Total Lifetime Payout', amount: asPrice(data.lifetime_amount) },
    ]);
