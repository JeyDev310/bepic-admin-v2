...
export default function TableView(props) {
  const columns = [
    ...
    {
      title: t('common.table.totalSalesAmount', 'Total Sales Amount' ),
    ...
    {
      title: t('common.table.oneTimeAmount', 'Onetime Amount'),
    ...
    {
      title: t('common.table.autoshipAmount', 'Autoship Amount' ),
    ...
    {
      title: t('common.table.corpJoined', 'Corp joined' ),
