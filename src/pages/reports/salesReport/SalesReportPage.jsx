...
const SalesReportPage = () => {
  ...
  const onGetSuccessSalesHeader = (data) => {
    setStatsData([
      { title: 'Product Sales', amount: asPrice(data.product_sales) },
      { title: 'Cost Of Goods', amount: asPrice(data.cost_of_goods) },
      { title: 'Commissions Paid', amount: asPrice(data.commission_paid) },
      { title: 'Net Profit', amount: asPrice(data.net_profit) },
    ]);
  ...
  const onGetSuccessMonthlySales = (resp) => {
    console.log('---sales ---- monthly', resp);
